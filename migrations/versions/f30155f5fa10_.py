...
Revision ID: f30155f5fa10
Revises: None
Create Date: 2016-09-07 13:36:48.010411

"""

# revision identifiers, used by Alembic.
revision = 'f30155f5fa10'
down_revision = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['team1_id'], ['team.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['team2_id'], ['team.id'], ondelete='CASCADE'),
